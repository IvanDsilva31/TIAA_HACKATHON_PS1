        ...
        <div className="flex items-center justify-between lg:flex-col lg:gap-7">
          ...
          <form className="flex items-center justify-center relative">
            <input
              ...
              name="email"
              type={"email"}
              className="py-2 px-5 ring-1 ring-slate-300 flex items-center shadow-md shadow-slate-200 w-96 lg:w-[85vw] text-base rounded-full relative placeholder:text-slate-500 focus:outline-blue-500"
            />
            <button
              type="button"
              className="text-base px-5 py-2 text-white bg-gradient-to-b from-blue-500 to-blue-500 rounded-r-full transition-all duration-200 active:scale-90 absolute right-0 shadow-lg shadow-blue-400"
            >
              Submit
            </button>
          </form>
